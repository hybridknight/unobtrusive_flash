...
(function() {
  ...
  UnobtrusiveFlash.showFlashMessage = function(message, options) {
    ...
    var $flash = $('<div class="alert alert-'+options.type+' fade in"><div class="alert-content"><button type="button" class="close" data-dismiss="alert">&times;</button>'+message+'</div></div>');
